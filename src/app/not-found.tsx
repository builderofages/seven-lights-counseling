...
export default function NotFound() {
  return (
    <div className="relative flex min-h-[100svh] flex-col justify-center overflow-hidden bg-ink pb-24 pt-[calc(var(--header-h)+4rem)] text-paper">
      <video
      ...
      <div className="shell relative text-center">
        <LogoMark className="mx-auto h-9 w-auto text-clay" animate />
        <p className="eyebrow mt-9 text-clay">404</p>
        <h1 className="mt-6 font-display text-display-lg font-light">
          This page is not here.
        </h1>
        <p className="mx-auto mt-6 max-w-[46ch] text-lede text-paper/60">
          Which is a small inconvenience, and easily solved. Everything the
          practice offers is one link away.
        </p>

        <div className="mt-11 flex flex-wrap items-center justify-center gap-3">
          <Link href="/" className="btn-primary btn-lg !bg-paper !text-ink">
