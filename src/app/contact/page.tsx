      ...
      <section className="bg-paper py-section">
        <div className="shell grid gap-14 lg:grid-cols-12">
          <div className="lg:col-span-6">
            ...
            <dl className="mt-12 divide-y divide-ink/[0.13] border-y border-ink/[0.13]">
              <div className="grid gap-2 py-6 sm:grid-cols-3 sm:gap-6">
                <dt className="eyebrow pt-1">Phone</dt>
                <dd className="sm:col-span-2">
                  <a href={site.contact.phoneHref} className="link-sweep font-display text-[1.4rem] font-light text-ink">
                    {site.contact.phone}
                  </a>
              ...
              <div className="grid gap-2 py-6 sm:grid-cols-3 sm:gap-6">
                ...
                <dd className="sm:col-span-2">
                  <a href={`mailto:${site.contact.email}`} className="link-sweep font-display text-[1.4rem] font-light text-ink">
                    {site.contact.email}
                  </a>
                  <p className="mt-2 max-w-[46ch] font-sans text-[0.875rem] leading-relaxed text-bark/60">
              ...
              <div className="grid gap-2 py-6 sm:grid-cols-3 sm:gap-6">
                ...
                <dd className="sm:col-span-2">
                  <p className="font-sans text-[1rem] leading-relaxed text-bark/85">
              ...
              <div className="grid gap-2 py-6 sm:grid-cols-3 sm:gap-6">
                ...
                <dd className="sm:col-span-2">
                  <p className="max-w-[46ch] font-sans text-[1rem] leading-relaxed text-bark/85">
                ...
                <dd className="sm:col-span-2">
                  <ul className="space-y-1.5">
                    {site.contact.hours.map((h) => (
                      <li key={h.day} className="flex max-w-sm justify-between gap-6 font-sans text-[0.9375rem] text-bark/80">
                        <span>{h.day}</span>
          ...
          <div className="lg:col-span-5 lg:col-start-8">
            ...
            <Reveal delay={120} className="mt-8 rounded-2xl border border-light-1/25 bg-light-1/[0.06] p-6">
              ...
              <p className="mt-4 font-sans text-[0.9375rem] leading-relaxed text-bark/80">
                ...
                danger, call <strong className="text-ink">911</strong>. For urgent
